...
class BannerWidget extends StatefulWidget {
  ...
  BannerWidget(this.height, this.datas, {Key? key, this.duration = 5000,
  ...
  start() {
    ...
    timer = Timer.periodic(Duration(milliseconds: widget.duration), (timer) {
      if(widget.datas.length > 0 && controller != null && controller?.page != null) {
        controller?.animateToPage(controller?.page?.toInt() ?? 0 + 1,
...
class BannerItem {
  ...
  // static BannerItem bannerItem(String image) {
